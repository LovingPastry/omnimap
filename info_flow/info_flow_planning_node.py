...
def build_argparser():
    ...
    parser.add_argument("--planner_hz", type=float, default=30.0)
    ...
    parser.add_argument("--fisher_step_scale", type=float, default=1e-5)
    parser.add_argument("--linear_vel_max", type=float, default=0.05)
    parser.add_argument("--angular_gain", type=float, default=2.0)
    parser.add_argument("--radial_gain", type=float, default=0.2)
    parser.add_argument("--dt", type=float, default=1.0)
    parser.add_argument("--grad_eps", type=float, default=0.01)
    parser.add_argument("--spherical_speed_min", type=float, default=0.0)
