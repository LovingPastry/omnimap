...
def render_instance(viewpoint_camera:Camera, pc : GaussianModel, bg_color = torch.Tensor([0.2,0.2,0.2]).cuda(), scaling_modifier = 1.0):
    """
...
from modified_diff_gaussian_rasterization import GaussianRasterizationSettings as ModifiedGaussianRasterizationSettings
...
def modified_render(viewpoint_camera:Camera, pc : GaussianModel, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None):
    """
    Render the scene. 
